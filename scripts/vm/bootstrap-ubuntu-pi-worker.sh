...
for cmd in pi-worker-supervisor pi-worker-start pi-worker-status pi-worker-restart pi-worker-stop pi-worker-checkpoint pi-worker-tail-logs pi-worker-verify-runtime pi-worker-fail-inject pi-worker-runtime-checklist pi-worker-submit-job pi-worker-run-job pi-worker-gateway pi-worker-telegram-bot pi-worker-verify.sh pi-worker-supervisor-smoke-test pi-worker-gateway-smoke-test pi-worker-acpx-smoke-test; do
  ln -sf "$SCRIPT_DIR/$cmd" "$HOME/bin/$cmd"
done
chmod +x "$SCRIPT_DIR"/pi-worker-supervisor "$SCRIPT_DIR"/pi-worker-start "$SCRIPT_DIR"/pi-worker-status "$SCRIPT_DIR"/pi-worker-restart "$SCRIPT_DIR"/pi-worker-stop "$SCRIPT_DIR"/pi-worker-checkpoint "$SCRIPT_DIR"/pi-worker-tail-logs "$SCRIPT_DIR"/pi-worker-verify-runtime "$SCRIPT_DIR"/pi-worker-fail-inject "$SCRIPT_DIR"/pi-worker-runtime-checklist "$SCRIPT_DIR"/pi-worker-submit-job "$SCRIPT_DIR"/pi-worker-run-job "$SCRIPT_DIR"/pi-worker-gateway "$SCRIPT_DIR"/pi-worker-telegram-bot "$SCRIPT_DIR"/pi-worker-verify.sh "$SCRIPT_DIR"/pi-worker-supervisor-smoke-test "$SCRIPT_DIR"/pi-worker-gateway-smoke-test "$SCRIPT_DIR"/pi-worker-acpx-smoke-test "$SCRIPT_DIR"/pi-worker-gateway.ts "$SCRIPT_DIR"/pi-worker-telegram-bot.ts "$SCRIPT_DIR"/pi-worker-submit-job.ts "$SCRIPT_DIR"/pi-worker-run-job.ts
