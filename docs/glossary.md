...
| **ACP session** | Conversation state owned by ACPX. | worker session, tmux session, Telegram session |
...
| **Execution plane** | Job execution surface: gateway, Telegram bot, runner, queue, ACPX. | operator plane |
